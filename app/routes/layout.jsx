...
export default function Layout() {
  return (
    <main>
      ...
      <div className="fixed top-16 left-6 w-16 h-16 border-t-2 border-l-2 border-blue-400/30 animate-pulse z-50 transition-all duration-300"></div>
      <div className="fixed top-16 right-6 w-16 h-16 border-t-2 border-r-2 border-blue-400/30 animate-pulse [animation-delay:300ms] z-50 transition-all duration-300"></div>
